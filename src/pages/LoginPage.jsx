...
// Supabase removed — login uses Redux loginApi which handles auth
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-4">
      <div className="w-full max-w-md shadow-lg border border-blue-200 rounded-lg bg-white">
        <div className="space-y-1 p-4 bg-gradient-to-r from-blue-100 to-purple-100 rounded-t-lg text-center">
              ...
              <div className="px-6 pb-8 space-y-4">
                ...
                {forgotStep === 'reset' && (
                  <form onSubmit={async (e) => {
                    ...
                    setIsForgotLoading(true);
                    try {
                      // Password reset — handled without Supabase
                      console.log("Password reset requested for:", forgotData.username);
