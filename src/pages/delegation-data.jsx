  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      if (recordedAudio && recordedAudio.blob) {
        // Audio upload disabled — Supabase storage removed
        console.warn("Audio upload skipped — no storage backend configured.");
        showToast("Voice note upload not available (storage removed)", "error");
      ...
      if (audioToCleanup) {
        console.log("Old audio cleanup skipped — no storage backend:", audioToCleanup);
      }
